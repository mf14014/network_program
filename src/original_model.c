...
void read_data_set_func(char *filename, double *cooperation_parameter,
                        double *island_number_av_array, double *agent_number_av_array,
                        double *culture_number_av_array, double *cluster_number_av_array,
                        double *shortest_path_av_array, double *bridge_number_av_array,
                        double *island_number_variance_array, double *agent_number_variance_array,
                        double *culture_number_variance_array, double *cluster_number_variance_array,
                        double *shortest_path_variance_array, double *bridge_number_variance_array,
                        double *island_number_standard_deviation_array, double *agent_number_standard_deviation_array,
                        double *culture_number_standard_deviation_array, double *cluster_number_standard_deviation_array,
                        double *shortest_path_standard_deviation_array, double *bridge_number_standard_deviation_array) {
    FILE *fp;
    ...
    if (fp == NULL) {
        ...
        while (fscanf(fp, "%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf ,%lf",
                cooperation_parameter,
                island_number_av_array, agent_number_av_array,
                culture_number_av_array, cluster_number_av_array,
                shortest_path_av_array, bridge_number_av_array,
                island_number_variance_array, agent_number_variance_array,
                culture_number_variance_array, cluster_number_variance_array,
                shortest_path_variance_array, bridge_number_variance_array,
                island_number_standard_deviation_array, agent_number_standard_deviation_array,
                culture_number_standard_deviation_array, cluster_number_standard_deviation_array,
                shortest_path_standard_deviation_array, bridge_number_standard_deviation_array) != EOF) {
            cooperation_parameter++;
...
int main(void){
    ...
    if (read_data_set) {
        if (make_torus == 0) {
            read_data_set_func(filename5, cooperation_parameter,
                    island_number_av_array, agent_number_av_array,
                    culture_number_av_array, cluster_number_av_array,
                    shortest_path_av_array, bridge_number_av_array,
                    island_number_variance_array, agent_number_variance_array,
            ...
            read_data_set_func(filename7, cooperation_parameter,
                    island_number_av_array, agent_number_av_array,
                    culture_number_av_array, cluster_number_av_array,
                    shortest_path_av_array, bridge_number_av_array,
                    island_number_variance_array, agent_number_variance_array,
...
//                            fprintf(fp,"<ns0:color b=\"%d\" g=\"%d\" r=\"%d\" />\n", ag[i].f[0] * rgb_conversion, ag[i].f[1] * rgb_conversion, ag[i].f[2] * rgb_conversion);
        ...
        if (read_data_set) {
            ...
            if ((island_number_av_array[index_mark] - sigma_option*island_number_standard_deviation_array[index_mark] < island_dummy)
                && (island_dummy < island_number_av_array[index_mark] + sigma_option*island_number_standard_deviation_array[index_mark])
                && (shortest_path_av_array[index_mark] - sigma_option*shortest_path_standard_deviation_array[index_mark] < distance_dummy)
                && (distance_dummy < shortest_path_av_array[index_mark] + sigma_option*shortest_path_standard_deviation_array[index_mark])
                && (cluster_number_av_array[index_mark] - sigma_option*cluster_number_standard_deviation_array[index_mark] < cluster_dummy)
                && (cluster_dummy < cluster_number_av_array[index_mark] + sigma_option*cluster_number_standard_deviation_array[index_mark])) {
                break;
            }
            simulation_count++;
